...
## Rule
After any fresh GitHub import into Replit, `node_modules/` directories are absent. The MevrelBank backend and frontend need `npm install` before their workflows can start.
...
Then restart the two MevrelBank workflows:
