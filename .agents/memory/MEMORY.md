...
- [MevrelBank repo layout](mevrelbank-layout.md) — the real frontend is nested deep under mevrelbank/design-systems/agents/figma/; retired gateway source lives only in the evidence archive.
...
- [Fresh import restores](fresh-import-restores.md) — after a GitHub import, install dependencies in the MevrelBank backend and frontend before restarting workflows.
